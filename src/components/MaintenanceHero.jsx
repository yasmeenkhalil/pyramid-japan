import { ArrowRight, Wrench, ShieldCheck, Settings } from "lucide-react";

export default function MaintenanceHero() {
  return (
    <section className="relative overflow-hidden bg-[#0b192e] px-4 pt-0">
      {/* البوكس الداخلي الموزون الفخم المستدير الحواف */}
        ...
        <div className="relative z-10 w-full p-5 md:p-12 grid items-center gap-12 lg:grid-cols-12">
          ...
          <div className="lg:col-span-7 max-w-2xl">
            ...
            <p className="mt-4 text-sm md:text-base leading-relaxed text-slate-400">
              Ensure long-term operational uptime. Our certified Japanese engineers perform complete diagnostic overhauls, engine calibrations, and hydraulic rebuilding before any machine leaves our yards.
            </p>
            ...
            {/* Stats الإحصائيات الفنية لمركز الصيانة */}
            <div className="mt-10 grid grid-cols-3 gap-4 border-t border-white/5 pt-6 max-w-md">
              ...
              <div>
                <h3 className="text-2xl font-black text-[#d9a441]">Certified</h3>
                <p className="mt-1 text-[11px] font-medium text-slate-400 uppercase tracking-wider">
                  JAO Engineers
                </p>
              </div>
              ...
              <div>
                <h3 className="text-2xl font-black text-[#d9a441]">Genuine</h3>
                <p className="mt-1 text-[11px] font-medium text-slate-400 uppercase tracking-wider">
                  OEM Components
                </p>
              </div>
          ...
          <div className="lg:col-span-5 hidden lg:flex flex-col gap-4 justify-center items-end">
            ...
            <div className="flex items-center gap-4 rounded-2xl border border-white/10 bg-[#112240]/50 p-5 backdrop-blur-md w-full max-w-[320px] shadow-xl transition hover:border-white/20">
              ...
              <div className="leading-tight">
                <h4 className="text-base font-bold text-white">Preventative Overhaul</h4>
                <p className="text-xs text-slate-400 mt-1">Full structural stress and crack testing</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 rounded-2xl border border-white/10 bg-[#112240]/50 p-5 backdrop-blur-md w-full max-w-[320px] shadow-xl transition hover:border-white/20">
              ...
              <div className="leading-tight">
                <h4 className="text-base font-bold text-white">Hydraulic Rebuilding</h4>
                <p className="text-xs text-slate-400 mt-1">Main pump pressure tests and resealing</p>
              </div>
            </div>
